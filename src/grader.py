...
class Test_1b(A2_TestCase):
  ...
  def test_1(self):
    ...
    self.assertEqual('two words', submission.segmentWords('twowords', self.unigramCost))
    self.assertEqual('and three words', submission.segmentWords('andthreewords', self.unigramCost))
  ...
  def test_3(self):
    ...
    for query in QUERIES_SEG:
      ...
      self.compare_with_solution_or_wait(submission, 'segmentWords', lambda f: [f(part, self.unigramCost) for part in parts])
...
class Test_2b(A2_TestCase):
  ...
  def test_3(self):
    ...
    for query in QUERIES_INS:
      ...
      self.compare_with_solution_or_wait(submission, 'insertVowels', lambda f: f(copy.deepcopy(ws), self.bigramCost, self.possibleFills))
class Test_3b(A2_TestCase):
  ...
  def test_0(self):
    ...
    self.assertEqual('two words', submission.segmentAndInsert('twwrds', bigramCost, fills))
    self.assertEqual('and three words', submission.segmentAndInsert('ndthrwrds', bigramCost, fills))
